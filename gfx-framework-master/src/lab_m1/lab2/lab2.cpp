...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //0
            VertexFormat(glm::vec3(1, -1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //1
            VertexFormat(glm::vec3(-1, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //2
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //3
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //4
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //5
            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //6
            VertexFormat(glm::vec3(1, 1, -1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)) //7
...

    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(3, 0, 0), glm::vec3(0, 1, 1)),
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0.7, 0.5, 0.5)),
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0.5, 0.7, 0.5)),
            VertexFormat(glm::vec3(1, 1, -1), glm::vec3(0.5, 0.5, 0.7)),
            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(0.3, 0.3, 0.5))
        };
        vector<unsigned int> indices =
        {
            0, 1, 2,
    ...
    }
    {
        vector<VertexFormat> vertices
        {
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //0
            VertexFormat(glm::vec3(1, -1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //1
            VertexFormat(glm::vec3(-1, 1, 1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //2
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(1, 0.5, 1), glm::vec3(0.2, 0.8, 0.6)), //3
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0, 0.5, 1), glm::vec3(0.2, 0.8, 0.6)), //4
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0, 1, 0.5), glm::vec3(0.2, 0.8, 0.6)), //5
            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(0.5, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //6
            VertexFormat(glm::vec3(1, 1, -1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)) //7
        };
        vector<unsigned int> indices =
        {
            0, 1, 2,    // indices for first triangle
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.45f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-1, -1, -1), glm::vec3(0.5f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(3, 0, 3), glm::vec3(0.8f));

  //  RenderMesh(meshes["Cube_C"], shaders["VertexColorBlend"], glm::vec3(-3, 0, -3), glm::vec3(0.4f));
